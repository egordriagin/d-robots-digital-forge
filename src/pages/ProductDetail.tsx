    ...
    return (
      <div className="min-h-screen py-8 flex items-center justify-center">
        <div className="text-center">
          <div className="animate-spin rounded-full h-32 w-32 border-b-2 border-[#3498DB] mx-auto"></div>
          <p className="mt-4 text-lg text-gray-600">Загрузка продукта...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="min-h-screen py-8">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-gray-600 mb-8">
            Произошла ошибка при загрузке продукта. Попробуйте обновить страницу.
          </p>
          <Link to="/">
