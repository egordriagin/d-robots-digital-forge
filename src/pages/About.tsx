...
const About = () => {
  ...
  return (
    <>
      <Helmet>
        <title>О компании - 3D Robots</title>
        <meta name="description" content="ООО «Аддитивные Системы и Робототехника» - ведущий поставщик решений для цифрового производства. Более 1000 довольных клиентов, официальная поддержка, участие в федеральных контрактах ЕАЭС." />
        <meta name="keywords" content="3D Robots, Аддитивные Системы и Робототехника, о компании, цифровое производство, промышленное оборудование" />
        
        {/* Open Graph tags */}
        <meta property="og:title" content="О компании - 3D Robots" />
        <meta property="og:description" content="ООО «Аддитивные Системы и Робототехника» - ведущий поставщик решений для цифрового производства. Более 1000 довольных клиентов, официальная поддержка, участие в федеральных контрактах ЕАЭС." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content={window.location.href} />
        <meta property="og:image" content="https://3d-robots.com/images/about-og-image.jpg" />
        <meta property="og:site_name" content="3D Robots" />
        <meta property="og:locale" content="ru_RU" />
        
        {/* Twitter Card tags */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="О компании - 3D Robots" />
        <meta name="twitter:description" content="ООО «Аддитивные Системы и Робототехника» - ведущий поставщик решений для цифрового производства. Более 1000 довольных клиентов." />
        <meta name="twitter:image" content="https://3d-robots.com/images/about-og-image.jpg" />
