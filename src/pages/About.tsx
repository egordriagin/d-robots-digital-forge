        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16 items-center">
          <div>
            ...
            <div className="space-y-4 text-gray-700 leading-relaxed">
              <p>
                Компания 3D Robots — ведущий поставщик комплексных решений цифрового производства в России и странах ЕАЭС. Мы специализируемся на внедрении передовых технологий 3D-печати, робототехники, станков с ЧПУ и 3D-сканирования для промышленных предприятий, научных центров и образовательных учреждений.
              </p>
              <p>
