        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16 items-center">
          <div>
            ...
            <div className="space-y-4 text-gray-700 leading-relaxed">
              <p>
                Санкт-петербургская компания 3D Robots — ведущий поставщик комплексных решений цифрового производства в России и странах ЕАЭС. Мы специализируемся на внедрении передовых технологий 3D-печати, робототехники, станков с ЧПУ и 3D-сканирования для промышленных предприятий, научных центров и образовательных учреждений.
              </p>
              <p>
                Наш портфель успешно реализованных проектов включает сотрудничество с более чем 1000 организаций — от крупнейших корпораций, таких как X5 Group, Татнефть и LG Electronics, до престижных учебных заведений, включая МГУ, ИТМО, Политех и МГТУ «СТАНКИН».
              </p>
              <p>
                Как активный участник федеральной контрактной системы, мы успешно реализуем проекты государственного значения на территории Российской Федерации и стран-партнеров ЕАЭС — Армении, Беларуси, Казахстана и Киргизии, способствуя технологическому развитию региона и укреплению промышленного потенциала союзных государств.
              </p>
            </div>
          </div>
          <div>
