      ...
      <div className="border border-gray-200 rounded-lg p-6 bg-gray-50">
        ...
        <div className="space-y-3">
          <div className="flex justify-between items-center">
            ...
            <span className="text-xl font-bold text-[#1F669D]">{pricing.base}</span>
          </div>
          {pricing.withAMS && (
            <div className="flex justify-between items-center">
              <span>С системой AMS</span>
              <span className="text-xl font-bold text-[#1F669D]">{pricing.withAMS}</span>
            </div>
          )}
          {pricing.withAccessories && (
            <div className="flex justify-between items-center">
              <span>Полная комплектация</span>
              <span className="text-xl font-bold text-[#1F669D]">{pricing.withAccessories}</span>
            </div>
          )}
        </div>
