...
export const transformDatabaseRoboticDogSpecs = (dbSpecs: DatabaseRoboticDogSpecs): RoboticDogSpecifications => {
  return {
    ...
    power: {
      batteryCapacity: dbSpecs.power_battery_capacity || '',
      batteryType: dbSpecs.power_battery_type || '',
      batteryRuntime: dbSpecs.power_battery_runtime || '',
      batteryHotSwap: dbSpecs.power_battery_hot_swap || '',
      consumptionAverage: dbSpecs.power_consumption_average || '',
      consumptionPeak: dbSpecs.power_consumption_peak || '',
...
export const transformDatabaseRoboticArmSpecs = (dbSpecs: DatabaseRoboticArmSpecs): RoboticArmSpecifications => {
  return {
    capacity: {
      ...
      momentOfInertia: dbSpecs.capacity_moment_inertia || '',
    ...
    safety: {
      ...
      boundaries: dbSpecs.safety_boundaries || '',
      emergencyStop: dbSpecs.safety_emergency_stop || '',
...
export const transformDatabaseLaserCutterSpecs = (dbSpecs: DatabaseLaserCutterSpecs): LaserCutterSpecifications => {
  return {
    ...
    workArea: {
      areaSize: dbSpecs.work_area_size || '',
    ...
    vision: {
      ...
      accuracy: dbSpecs.vision_accuracy || '',
    ...
    control: {
      ...
      methods: dbSpecs.control_methods || '',
    ...
    cooling: {
      capacity: dbSpecs.cooling_capacity || '',
    ...
    materials: {
      ...
      parameters: dbSpecs.materials_parameters || ''
    }
  };
};
