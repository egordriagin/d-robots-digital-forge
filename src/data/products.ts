...
export const products: Product[] = [
  // 3D Printers
  {
    ...
    shortDescription: "Высокоскоростной 3D-принтер с автоматической мультиматериальной системой подачи AMS и интеллектуальными функциями.",
    fullDescription: `
      <p>Bambu Lab X1 Carbon представляет собой революционный подход к 3D-печати, объединяя невероятную скорость, точность и удобство использования. Этот принтер оснащен передовыми технологиями, включая автоматическую систему подачи материалов AMS, которая позволяет печатать до 16 различных материалов и цветов в одном проекте.</p>
      
      <p>Принтер оснащен интеллектуальной системой контроля качества с использованием ИИ, которая автоматически обнаруживает и исправляет ошибки печати в режиме реального времени. Закрытая камера печати обеспечивает стабильную температуру и защиту от внешних воздействий.</p>
      
      <p>X1 Carbon идеально подходит как для профессионального использования в дизайн-студиях и инженерных отделах, так и для энтузиастов, которые требуют максимального качества и надежности от своего оборудования.</p>
    `,
    images: [
      "/lovable-uploads/0463bb2c-5a77-45f4-8949-fb24344ec40d.png",
      "/lovable-uploads/a7fbb447-0b21-4ec5-a249-ef48ca4cbf39.png",
      "/lovable-uploads/d3e9cbf5-67de-4b77-898e-f1440867d04f.png",
      "/lovable-uploads/8cac2f17-5bc8-42db-92f3-0a5e3ee365df.png",
      "/lovable-uploads/174f8417-75ac-429d-b807-18b48208ac76.png"
    ],
    pricing: {
      base: "от 329 000 ₽",
      withAMS: "449 000 ₽",
      withAccessories: "от 379 000 ₽"
    },
    leadTime: "7-14 дней",
    ...
    features: [
      ...
      "Автоматическая система подачи материалов AMS",
      "ИИ-контроль качества с компьютерным зрением",
      "Закрытая камера с контролем температуры",
      "Автоматическая калибровка и выравнивание стола",
      "Поддержка 16+ типов филамента",
      "Встроенная система фильтрации воздуха",
      "Удаленный мониторинг через мобильное приложение"
    ],
    shipping: {
      cost: "Бесплатная доставка",
      freeThreshold: "При заказе от 100 000 ₽"
    },
  ...
  },
  {
    ...
    images: [
      "/lovable-uploads/a50568cf-cc66-4739-9c64-8b0a9985f3e9.png",
      "/lovable-uploads/25f75f0a-a272-4587-aed4-a6a145540721.png",
      "/lovable-uploads/8a156e90-21a2-460d-846f-b6b5a75e7b75.png",
      "/lovable-uploads/031eb4b8-2ea4-4ebc-bcd8-d2ca36c1a5cc.png"
    ],
    pricing: {
      base: "от 985 000 ₽",
